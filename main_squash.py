...
def train_two_models(model_one, model_two, epoch, batch_size, lr_schedule=None):
    ...
    output = open(f'/home/sc.uni-leipzig.de/ms53dumu/InconvenientWeightsUpdate/results_squash_const_lr_0.01/bs-{batch_size};layers-{num_of_layers};BN={is_bn};lr-{round(model_one.lr, 7)}.pkl', 'wb')
    pickle.dump(
...
lrs_list = [init_lr for i in range(1, len(batch_sizes))]
